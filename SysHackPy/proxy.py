...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    if receive_first:
            ...
            # if we have daa to send to our local client, send it
      ...
      while True:
          ...
          if len(remote_buffer):
              ...
              print "[<==] Received %d bytes from remote." %d len(remote_buffer)
              hexdump(remote_buffer)
          ...
          # if no more data on either side, slose the connections
          if not len(local_buffer) or not len(remote_buffer):
              client_socket.close()
              remote_socket.close()
              print "[*] No more data. Closein connections."
...
#modify any responser destined for the local host
